...
namespace TheTechIdea.DataManagment_Engine.ETL.MappingRules
{
    [AddinAttribute(Caption = "Default String", Name = "String", misc = "Defaults", addinType = AddinType.Class,returndataTypename ="string")]
